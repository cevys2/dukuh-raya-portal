            ...
            {isAdmin && (
              <div className="flex rounded-lg border border-slate-200 p-1 text-sm">
                <button
                  type="button"
                  onClick={() => setTab("apps")}
                  className={`rounded-md px-3 py-1.5 font-medium ${tab === "apps" ? "bg-slate-100 text-slate-900" : "text-slate-500"}`}
                >
                  Aplikasi
                </button>
                <button
                  ...
                  className={`flex items-center gap-1.5 rounded-md px-3 py-1.5 font-medium ${tab === "admin" ? "bg-slate-100 text-slate-900" : "text-slate-500"}`}
                >
                  <ShieldCheck size={14} />
                  Kelola Akses
                </button>
